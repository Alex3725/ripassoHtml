...
const btn = document.getElementById('ordina');
...
btn.addEventListener('click', () => {
  ...
  // funzione molto utile del sort che se inserite due variabili fa in automatico la es lista [4,7,10] prende [4,7] e confronta, [7,10], confronta ed eccetra
